...
// HasAccountTypes applies the HasEdge predicate on the "accountTypes" edge.
func HasAccountTypes() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasEventTypes applies the HasEdge predicate on the "eventTypes" edge.
func HasEventTypes() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
