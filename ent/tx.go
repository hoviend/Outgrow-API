...
func (tx *Tx) init() {
	...
	tx.MasterAccount = NewMasterAccountClient(tx.config)
	tx.MasterAccountCategory = NewMasterAccountCategoryClient(tx.config)
	tx.MasterAccountType = NewMasterAccountTypeClient(tx.config)
	tx.MasterEventType = NewMasterEventTypeClient(tx.config)
	tx.Organization = NewOrganizationClient(tx.config)
	tx.OrganizationAccount = NewOrganizationAccountClient(tx.config)
	tx.OrganizationAccountCategory = NewOrganizationAccountCategoryClient(tx.config)
	tx.OrganizationAccountType = NewOrganizationAccountTypeClient(tx.config)
	tx.OrganizationEventType = NewOrganizationEventTypeClient(tx.config)
